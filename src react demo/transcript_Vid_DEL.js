...
const Transcript_Vid_DEL = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:4000/subtitle/1/del', {
      ...
      .then(data => {
        setMessage('Transcript video id 1 successfully deleted!');
...
export default Transcript_Vid_DEL;
